...
class MColors {
  ...
  // Color(0xff76974C);
  static Color colorPrimary =Color(int.parse('0xFF6a0c80'));

  // Color(0xffE8F0DE);
  static  Color colorPrimaryLight = Color(int.parse('0xffe7bcfa'));

  // Color(0xff76974C);
  static  Color colorPrimaryDark = Color(int.parse('0xFF3b0042'));

  //Color(0xffb6aeae);
  static  Color colorSecondary = Color(int.parse('0xffb6aeae'));

  //Color(0xffe8e0e0);
  static  Color colorSecondaryLight = Color(int.parse('0xffe8e0e0'));

  // Color(0xff867f7f);
  static  Color colorSecondaryDark = Color(int.parse('0xff867f7f'));
